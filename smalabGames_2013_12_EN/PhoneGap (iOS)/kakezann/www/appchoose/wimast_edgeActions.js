...
//Edge binding end
Symbol.bindElementAction(compId, symbolName, "${_Symbol_1}", "touchstart", function(sym,e){window.open("appgames/witchmath_ipad/selectstage_ipad.html","_self");});
//Edge binding end
Symbol.bindElementAction(compId, symbolName, "${_Symbol_1}", "click", function(sym,e){window.open("appgames/witchmath_ipad/selectstage_ipad.html","_self");});
//Edge binding end
})("stage");
