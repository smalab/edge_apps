...
"stage": {
   ...
   content: {
         ...
         },
         {
            ...
            text:"In Cards multiplied, you win if the multiplication of the numbers on your cards is bigger than the opponent's. ",
...
"Symbol_5": {
   ...
   dom: [
   {
      rect: ['0px','0px','280px','50px','auto','auto'],
      borderRadius: ['10px','10px','10px','10px'],
      boxShadow: ['',3,3,3,0,'rgba(0,0,0,0.65)'],
      id: 'RoundRect2',
      stroke: [0,'rgb(0, 0, 0)','none'],
      type: 'rect',
      fill: ['rgba(255,214,58,1.00)']
   },
   {
      rect: ['17px','10px','246px','40px','auto','auto'],
      font: ['\'ヒラギノ角ゴ Pro W3\', \'Hiragino Kaku Gothic Pro\', \'メイリオ\', Meiryo, \'ＭＳＰゴシック\', MS PGothic, sans-serif',24,'rgba(0,0,0,1)','normal','none',''],
      id: 'Text3Copy',
      text: 'Hard level',
      align: 'center',
