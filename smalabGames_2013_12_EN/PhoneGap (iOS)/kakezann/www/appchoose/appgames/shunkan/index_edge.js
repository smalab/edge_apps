...
"Ans": {
   ...
   {
      font: ['\'ヒラギノ角ゴ Pro W3\', \'Hiragino Kaku Gothic Pro\', メイリオ, Meiryo, ＭＳＰゴシック, \'MS PGothic\', sans-serif',40,'rgba(255,0,0,1.00)','normal','none','normal'],
      type: 'text',
      id: 'Ans_text01',
      text: 'Apples in the pictures',
      align: 'left',
      rect: ['60px','0px','401px','90px','auto','auto']
   }],
   symbolInstances: [
   ]
   },
...
"GAME_BACKGROUND": {
   ...
   timelines: {
      "Default Timeline": {
         ...
         autoPlay: true,
         timeline: [
            { id: "eid478", tween: [ "style", "${_Ans}", "left", '7px', { fromValue: '7px'}], position: 0, duration: 0 }         ]
      }
   }
},
"Apple3_flash": {
...
"FINISH": {
   ...
   },
   {
      ...
      display: 'none',
      id: 'result01',
      text: 'Avoid errors and<br>pushing start buttons!！',
      align: 'center',
      type: 'text'
   },
   {
