...
"stage": {
   ...
   content: {
         ...
         },
         {
            id:'home',
            type:'rect',
            rect:['121px','351px','auto','auto','auto','auto'],
            transform:[[],[],[],['0.11429','0.11429']]
         }],
         symbolInstances: [
         {
            id:'home',
   ...
   timelines: {
      "Default Timeline": {
         ...
         timeline: [
            ...
            { id: "eid281", tween: [ "style", "${_matane}", "left", '22px', { fromValue: '22px'}], position: 0, duration: 0 },
            { id: "eid283", tween: [ "style", "${_matane}", "width", '262px', { fromValue: '262px'}], position: 0, duration: 0 },
...
"stm2": {
   ...
   },
   {
      ...
      id: 'Text12',
      text: 'Digits to throw. Select two numbers. If the sum of the three numbers matches the digit of the monster, you can attack it!',
      align: 'left',
