...
ok10=0;
      ...
      Symbol.bindElementAction(compId, symbolName, "${_startbutton}", "click", function(sym, e) {
         ...
         sym.$("box2").css("backgroundColor","#ffaaaa")
         sym.$("box3").css("backgroundColor","#d9fffc")
         sym.$("box4").css("backgroundColor","#d9fffc")
         sym.$("box5").css("backgroundColor","#fdf9be")
         sym.$("box6").css("backgroundColor","#aaffed")
         sym.$("box7").css("backgroundColor","#b1c1ff")
         sym.$("box8").css("backgroundColor","#ffaaaa")
         sym.$("box9").css("backgroundColor","#fdf9be")
         sym.$("box10").css("backgroundColor","#aaffed")
         sym.$("box11").css("backgroundColor","#b1c1ff")
         sym.$("box12").css("backgroundColor","#d0fbd0")
         sym.$("box13").css("backgroundColor","#e7b1ff")
         sym.$("box14").css("backgroundColor","#e7b1ff")
         sym.$("box15").css("backgroundColor","#d0fbd0")
         sym.$("box16").css("backgroundColor","#d0fbd0")
