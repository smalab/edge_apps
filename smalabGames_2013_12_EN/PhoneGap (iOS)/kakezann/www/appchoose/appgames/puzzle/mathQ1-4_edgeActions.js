...
var Composition = Edge.Composition, Symbol = Edge.Symbol; // よく使用する Edge クラスのエイリアス
   ...
   (function(symbolName) {
      ...
      Symbol.bindElementAction(compId, symbolName, "${_okbotan}", "click", function(sym, e) {
         ...
         sym.$("Text5").css("backgroundColor","#f84796")
         }
         ...
         okplus=ok1+ok2+ok3+ok4+ok5+ok6+ok7+ok8+ok9+ok10+ok11
         
         if(okplus==11){
         
         if(flag==0){
         bgm.stop();
         localStorage.MATHQst4=1
         katim.play();
         }
         sym.play();
         }
      ...
      Symbol.bindElementAction(compId, symbolName, "document", "compositionReady", function(sym, e) {
         //#fcccf3#fdf9be#d0fbd0#f9ba87#d0fbd0
         
         
         sym.$("box1").css("backgroundColor","#fcccf3")
         sym.$("box2").css("backgroundColor","#fdf9be")
         sym.$("box3").css("backgroundColor","#d0fbd0")
         sym.$("box4").css("backgroundColor","#fcccf3")
         sym.$("box5").css("backgroundColor","#fdf9be")
         sym.$("box6").css("backgroundColor","#f9ba87")
         sym.$("box7").css("backgroundColor","#d0fbd0")
         sym.$("box8").css("backgroundColor","#fdf9be")
