...
"stage": {
   ...
   content: {
         ...
         },
         {
            id:'home',
            type:'rect',
            rect:['158','503','auto','auto','auto','auto']
         }],
         symbolInstances: [
         {
            id:'time_1',
   ...
   states: {
      "Base State": {
         ...
         "${_home}": [
            ["transform", "scaleX", '0.15692'],
            ["transform", "scaleY", '0.14249'],
            ["style", "left", '431px'],
            ["style", "top", '750px']
         ],
         "${_Symbol_1}": [
   ...
   timelines: {
      "Default Timeline": {
         ...
         timeline: [
            ...
            { id: "eid639", tween: [ "transform", "${_home}", "scaleX", '0.15692', { fromValue: '0.15692'}], position: 0, duration: 0 },
            ...
            { id: "eid640", tween: [ "transform", "${_home}", "scaleY", '0.14249', { fromValue: '0.14249'}], position: 0, duration: 0 },
            ...
            { id: "eid638", tween: [ "style", "${_home}", "left", '431px', { fromValue: '431px'}], position: 0, duration: 0 },
            { id: "eid637", tween: [ "style", "${_home}", "top", '750px', { fromValue: '750px'}], position: 0, duration: 0 }         ]
      }
   }
},
"start": {
...
"Symbol_1": {
   ...
   },
   {
      ...
      },
      {
         ...
         align: 'center',
         id: 'Text6Copy',
         text: 'Congrats!!<br>Mission complete!',
   ...
   timelines: {
      "Default Timeline": {
         ...
         timeline: [
            ...
            { id: "eid644", tween: [ "style", "${_mondaisu}", "width", '190px', { fromValue: '190px'}], position: 0, duration: 0 },
            ...
            { id: "eid643", tween: [ "style", "${_mondaisu}", "left", '379px', { fromValue: '379px'}], position: 0, duration: 0 },
            ...
            { id: "eid641", tween: [ "style", "${_total_yen}", "left", '232px', { fromValue: '232px'}], position: 0, duration: 0 },
            ...
            { id: "eid642", tween: [ "style", "${_dore2}", "left", '12px', { fromValue: '12px'}], position: 0, duration: 0 },
...
"mondai2": {
   ...
   },
   {
      id: 'norma',
      type: 'group',
      rect: ['718px','72px','296','105','auto','auto'],
      c: [
      {
   ...
   },
   {
      id: 'dore',
      type: 'group',
      rect: ['5px','49px','334px','100px','auto','auto'],
      c: [
      {
   ...
   },
   {
      ...
      },
      {
         ...
         id: 'Text6',
         text: 'Congrats!<br>Mission complete<br>The end',
         align: 'center',
         type: 'text'
      },
      {
   ...
   timelines: {
      "Default Timeline": {
         ...
         timeline: [
            ...
            { id: "eid646", tween: [ "style", "${_total_yen}", "top", '107px', { fromValue: '107px'}], position: 0, duration: 0 },
            { id: "eid26", tween: [ "color", "${_total_yen}", "color", 'rgba(255,7,7,1.00)', { animationColorSpace: 'RGB', valueTemplate: undefined, fromValue: 'rgba(255,7,7,1.00)'}], position: 0, duration: 0 },
            ...
            { id: "eid647", tween: [ "style", "${_norma1}", "left", '-36px', { fromValue: '-36px'}], position: 0, duration: 0 },
            ...
            { id: "eid645", tween: [ "style", "${_total_yen}", "left", '59px', { fromValue: '59px'}], position: 0, duration: 0 },
...
"hajime2": {
   ...
   },
   {
      ...
      id: 'Text4',
      text: 'Now<br>push the start button<br>and lets begin！！',
      align: 'left',
