...
var Composition = Edge.Composition, Symbol = Edge.Symbol; // よく使用する Edge クラスのエイリアス
   ...
   (function(symbolName) {
      ...
      Symbol.bindTriggerAction(compId, symbolName, "Default Timeline", 12250, function(sym, e) {
         ...
         localStorage.KAKEscore5 = counter;
      ...
      Symbol.bindElementAction(compId, symbolName, "${_rennsyuuend}", "touchstart", function(sym, e) {
         
         
         sym.getSymbol("rennsyuustage").deleteSymbol();
         
         
         sym.$("rennsyuuend").hide();
...
|| navigator.userAgent.indexOf('iPod') > 0 || navigator.userAgent.indexOf('Android') > 0) {
	return;
      ...
      Symbol.bindElementAction(compId, symbolName, "${_rennsyuuend}", "click", function(sym, e) {
  if ( navigator.userAgent.indexOf('iPhone') > 0 || navigator.userAgent.indexOf('iPad') > 0 
|| navigator.userAgent.indexOf('iPod') > 0 || navigator.userAgent.indexOf('Android') > 0) {
	return;
}       // マウスクリックのコードをここに挿入します
...
sym.setVariable("nextcounter", 1);
      ...
      Symbol.bindElementAction(compId, symbolName, "${_next}", "touchstart", function(sym, e) {
         ...
         case 11: sym.$("text").html("では、practiceおわるをおしてね！");break;
         　　　　　　　　　　　　　　　　　　　　　　　　　　　　
         ...
         case 14: sym.$("text").html("coinsでしょうぶがきまるよ！");break;
      ...
      Symbol.bindElementAction(compId, symbolName, "${_card7coverCopy}", "touchstart", function(sym, e) {
         ...
         sym.$("text").html("ほんばんはカードをえらび直せるよ");
