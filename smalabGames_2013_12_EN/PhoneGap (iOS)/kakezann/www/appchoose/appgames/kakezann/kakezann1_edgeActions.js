...
var Composition = Edge.Composition, Symbol = Edge.Symbol; // よく使用する Edge クラスのエイリアス
   ...
   (function(symbolName) {
      ...
      Symbol.bindElementAction(compId, symbolName, "document", "compositionReady", function(sym, e) {
         ...
         sym.setVariable("slidecount", 50);
         
         sym.setVariable("CPslidecount", 50);
      ...
      Symbol.bindTriggerAction(compId, symbolName, "Default Timeline", 12250, function(sym, e) {
         ...
         ScoreUpdate(counter,"KAKEscore1");

      });
      //Edge binding end

      Symbol.bindElementAction(compId, symbolName, "${_gamestartbutton}", "touchstart", function(sym, e) {
         if (android_flag==0){button.play();}
         if (android_flag==0){kyarasen.play();}
      ...
      Symbol.bindElementAction(compId, symbolName, "${_startbutton}", "touchstart", function(sym, e) {
         ...
         if (android_flag==0){mySound.play();};
         
         
         sym.$("Text2").html("start the game！");
      ...
      Symbol.bindElementAction(compId, symbolName, "${_upbutton}", "touchstart", function(sym, e) {
         ...
         if (android_flag==0){coindown.play();};
         
         }else{
         
         
         if (android_flag==0){coinup.play();};
      ...
      Symbol.bindElementAction(compId, symbolName, "${_end_return}", "touchstart", function(sym, e) {
         ...
         window.open("kakezann.html", "_self");
...
sym.setVariable("nextcounter", 1);
      ...
      Symbol.bindElementAction(compId, symbolName, "${_next}", "touchstart", function(sym, e) {
         ...
         case 1:　sym.$("text").html("Cards multipliedは");
                                                     break;
         ...
         case 6:　sym.$("text").html("では、drawボタンをおして");
                                                      break;
         
         
         case 7:  sym.$("text").html("practiceをはじめよう！");
                                                 break;
         ...
         case 9:  sym.$("blue").show();
         sym.$("next").hide();
                 sym.$("text").hide();
                 sym.$("hukidasiCopy").hide();
                 sym.$("NOTtouch").hide();       break;
         
         case 10:sym.$("blue2").show();  
                 sym.$("next").hide();
                 sym.$("text").hide();
                 sym.$("hukidasiCopy").hide();
                 sym.$("NOTtouch").hide();       break;
                 
 case 11: sym.$("text").html("では、OKボタンをおしてね！");break;
         ...
         case 14: sym.$("text").html("coinsの数でしょうぶがきまるよ！");break;
 
         case 15: sym.$("text").html("では、ゲームをはじめよう！");break;
 
         case 16: rennsyuuend = sym.createChildSymbol("rennsyuuend", "Stage");
