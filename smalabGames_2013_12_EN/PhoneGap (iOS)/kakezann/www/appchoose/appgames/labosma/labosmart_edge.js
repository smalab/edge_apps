   ...
   timelines: {
      "Default Timeline": {
         ...
         timeline: [
            ...
            { id: "eid621", tween: [ "transform", "${_home}", "scaleX", '0.12948', { fromValue: '0.12948'}], position: 0, duration: 0 },
            ...
            { id: "eid623", tween: [ "transform", "${_home}", "scaleY", '0.12286', { fromValue: '0.12286'}], position: 0, duration: 0 },
            ...
            { id: "eid626", tween: [ "style", "${_home}", "top", '-52px', { fromValue: '-52px'}], position: 0, duration: 0 },
            { id: "eid582", tween: [ "style", "${_norma}", "font-size", '30px', { fromValue: '30px'}], position: 0, duration: 0 },
            { id: "eid625", tween: [ "style", "${_home}", "left", '391px', { fromValue: '391px'}], position: 0, duration: 0 },
   ...
   },
   {
      ...
      },
      {
         ...
         },
         {
            ...
            id: 'Text8',
            text: 'Congrats！<br>level１ clear！<br>',
            align: 'left',
            font: ['\'ヒラギノ角ゴ Pro W3\', \'Hiragino Kaku Gothic Pro\', メイリオ, Meiryo, ＭＳＰゴシック, \'MS PGothic\', sans-serif',25,'rgba(0,15,255,1.00)','normal','none','normal']
         }]
      }]
   ...
   },
   {
      ...
      },
      {
         ...
         },
         {
            ...
            rect: ['57px','23px','222px','81px','auto','auto'],
            id: 'Text8',
            text: 'Congrats！<br>level2 clear！<br>',
            align: 'left',
            font: ['\'ヒラギノ角ゴ Pro W3\', \'Hiragino Kaku Gothic Pro\', メイリオ, Meiryo, ＭＳＰゴシック, \'MS PGothic\', sans-serif',25,'rgba(0,15,255,1.00)','normal','none','normal']
         }]
      }]
...
"Title3": {
   ...
   },
   {
      ...
      },
      {
         ...
         id: 'Text9',
         text: 'ごめんさない<br>level３は、せいさくちゅうです。<br>もう少し待ってね<br>',
         align: 'center',
         font: ['\'ヒラギノ角ゴ Pro W3\', \'Hiragino Kaku Gothic Pro\', メイリオ, Meiryo, ＭＳＰゴシック, \'MS PGothic\', sans-serif',20,'rgba(0,15,255,1)','normal','none','normal']
      },
      {
