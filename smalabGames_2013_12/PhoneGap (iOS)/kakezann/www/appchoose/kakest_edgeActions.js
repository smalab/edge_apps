...
//Edge symbol: 'stage'
(function(symbolName){Symbol.bindElementAction(compId, symbolName, "${_Symbol_2}", "click", function(sym,e){sym.$('<iframe width="420" height="315" src="//www.youtube.com/embed/OfeU5FXLsO0" frameborder="0" allowfullscreen></iframe>').appendTo(sym.$("video"));sym.$("video").show();sym.$("cover").show();});
//Edge binding end
...
//Edge binding end
Symbol.bindElementAction(compId, symbolName, "${_Symbol_5}", "click", function(sym,e){window.open("appgames/kakezann/kakezann.html","_self");});
//Edge binding end
Symbol.bindElementAction(compId, symbolName, "${_Symbol_6}", "click", function(sym,e){window.open("appgames/kakezann/kakezann0.html","_self");});
//Edge binding end
})("stage");
