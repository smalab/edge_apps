...
if(document.addEventListener ){ 
   ...
   aLoader = [
    ...
    { load: "edge_includes/edge.2.0.0.min.js"},
          { load: "kakezann3_edge.js"},
          { load: "kakezann3_edgeActions.js"}];
...
preContent={
   dom: [
   {
      ...
      type:'image',
      tag:'img',
      rect:['328px','370px','367px','29px','auto','auto'],
      fill:["rgba(0,0,0,0)",'images/preloader3.gif','0px','0px']
   },
   {
      id:'Text2',
      type:'text',
      rect:['432px','318px','160px','43px','auto','auto'],
      text:"よみこみ中...<br>",
   ...
   },
   {
      ...
      type:'image',
      tag:'img',
      rect:['569px','206px','343px','346px','auto','auto'],
