...
ok10=0;
      ...
      Symbol.bindElementAction(compId, symbolName, "${_startbutton}", "click", function(sym, e) {
         ...
         //#fdf9be#ffaaaa#aaffed#b1c1ff#f9ba87#e7b1ff#d0fbd0#d9fffc
         
         sym.$("box1").css("backgroundColor","#fdf9be")
         sym.$("box2").css("backgroundColor","#d0fbd0")
         sym.$("box3").css("backgroundColor","#ffaaaa")
         sym.$("box4").css("backgroundColor","#d9fffc")
         sym.$("box5").css("backgroundColor","#fdf9be")
         sym.$("box6").css("backgroundColor","#ffaaaa")
         sym.$("box7").css("backgroundColor","#ffaaaa")
         sym.$("box8").css("backgroundColor","#d9fffc")
         sym.$("box9").css("backgroundColor","#b1c1ff")
         sym.$("box10").css("backgroundColor","#b1c1ff")
         sym.$("box11").css("backgroundColor","#f9ba87")
         sym.$("box12").css("backgroundColor","#e7b1ff")
         sym.$("box13").css("backgroundColor","#d0fbd0")
         sym.$("box14").css("backgroundColor","#b1c1ff")
         sym.$("box15").css("backgroundColor","#f9ba87")
         sym.$("box16").css("backgroundColor","#e7b1ff")
