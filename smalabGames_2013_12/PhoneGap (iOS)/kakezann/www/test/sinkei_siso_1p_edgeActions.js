...
//fadeOutの秒数
   ...
   (function(symbolName) {   
      ...
      Symbol.bindTriggerAction(compId, symbolName, "Default Timeline", 20000, function(sym, e) {
         ...
         ga('send', 'event', 'sin_kake', 'sni_kake_shuryo', '神経衰弱掛け算終了時得点','kake_score');
         sym.$("kei").show();
         sym.$("smak").show();
...
sym.play("com");
   ...
   (function(symbolName) {   
      ...
      Symbol.bindTriggerAction(compId, symbolName, "Default Timeline", 20000, function(sym, e) {
         ...
         sym.$("ten").html(toku+"点").show();
         sym.$("complete").html(p1+"点");
         ga('send', 'event', 'sin_tasi', 'sin_tasi_shuryo', '神経衰弱足し算終了時得点','tasi_score');
         sym.$("kei").show();
         sym.$("smat").show();
         sym.getComposition().getStage().$("smagru").hide();
...
sym.play("com");
   ...
   (function(symbolName) {   
      ...
      Symbol.bindTriggerAction(compId, symbolName, "Default Timeline", 20000, function(sym, e) {
         ...
         sym.$("ten").html(toku+"点").show();
         sym.$("complete").html(p1+"点");
         ga('send', 'event', 'sin_hiki', 'sni_hiki_shuryo', '神経衰弱引き算終了時得点','hiki_score');
         sym.$("kei").show();
         sym.$("smah").show();
         sym.getComposition().getStage().$("smagru").hide();
