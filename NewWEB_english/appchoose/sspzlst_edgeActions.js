...
//Edge symbol: 'stage'
(function(symbolName){Symbol.bindElementAction(compId,symbolName,"${_Symbol_2}","click",function(sym,e){sym.$('<iframe width="420" height="315" src="//www.youtube.com/embed/O6RG21qEpzs" frameborder="0" allowfullscreen></iframe>').appendTo(sym.$("video"));sym.$("video").show();sym.$("cover").show();});
//Edge binding end
...
//Edge binding end
Symbol.bindElementAction(compId,symbolName,"${_Symbol_1}","click",function(sym,e){window.open("appgames/puzzle/index.html","_self");});
//Edge binding end
})("stage");
