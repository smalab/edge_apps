...
var Composition = Edge.Composition, Symbol = Edge.Symbol; // よく使用する Edge クラスのエイリアス
   ...
   (function(symbolName) {
      ...
      Symbol.bindElementAction(compId, symbolName, "${_muzu}", "touchstart", function(sym, e) {
         ...
         window.open("kakezann1.html", "_self");
         button.play();
      ...
      Symbol.bindElementAction(compId, symbolName, "${_hutu}", "touchstart", function(sym, e) {
         window.open("kakezann2.html", "_self");
         button.play();

      });
      //Edge binding end

      Symbol.bindElementAction(compId, symbolName, "${_yasa}", "touchstart", function(sym, e) {
         window.open("kakezann3.html", "_self");
         button.play();
      ...
      Symbol.bindElementAction(compId, symbolName, "${_yasa}", "click", function(sym, e) {
         // マウスクリックのコードをここに挿入します
         window.open("kakezann3.html", "_self");
         button.play();
