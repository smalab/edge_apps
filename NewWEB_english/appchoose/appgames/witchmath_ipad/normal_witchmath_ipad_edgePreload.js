...
if(document.addEventListener ){ 
   ...
   aLoader = [
    ...
    { load: "edge_includes/edge.2.0.0.min.js"},
          { load: "normal_witchmath_ipad_edge.js"},
          { load: "normal_witchmath_ipad_edgeActions.js"}];
...
preContent={
   dom: [
   {
      ...
      type:'image',
      tag:'img',
      rect:['60','232','200px','17px','auto','auto'],
      fill:["rgba(0,0,0,0)",'images/preloader35.gif','0px','0px']
   },
   {
      id:'Text2',
      type:'text',
      rect:['61px','171px','200px','28px','auto','auto'],
      text:"読み込み中...<br>",
      align:"center",
   ...
   },
   {
      ...
      type:'image',
      tag:'img',
      rect:['237px','115px','49px','42px','auto','auto'],
      fill:["rgba(0,0,0,0)",'images/ponta.png','0px','0px']
   }]};//simpleContent
