...
"stage": {
   ...
   content: {
         dom: [
         {
            id:'smagru',
            type:'group',
            rect:['726px','175px','319px','261px','auto','auto'],
            c:[
            {
               id:'smako',
               type:'image',
               rect:['103px','23px','189px','216px','auto','auto'],
               fill:["rgba(0,0,0,0)",im+"smako.png",'0px','0px']
            },
            {
               id:'hukidasi2',
               type:'image',
               rect:['-7px','-35px','203px','171px','auto','auto'],
         ...
         },
         {
            id:'jyannru',
            type:'text',
            rect:['762px','162px','124px','auto','auto','auto'],
            text:"ジャンルをえらんでね",
            align:"left",
...
"kake": {
   ...
   },
   {
      ...
      c: [
      {
         id: 'smakok',
         type: 'image',
         rect: ['155px','72px','189px','216px','auto','auto'],
