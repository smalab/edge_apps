...
//		 }
      ...
      Symbol.bindElementAction(compId, symbolName, "${_returnchose}", "touchstart", function(sym, e) {
      ...
      Symbol.bindElementAction(compId, symbolName, "${_returnchose}", "click", function(sym, e) {
         if ( navigator.userAgent.indexOf('iPhone') > 0 || navigator.userAgent.indexOf('iPad') > 0 
         || navigator.userAgent.indexOf('iPod') > 0 || navigator.userAgent.indexOf('Android') > 0) {
         	return;
         }
