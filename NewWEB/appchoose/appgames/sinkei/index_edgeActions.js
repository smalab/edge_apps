...
//fadeOutの秒数
   ...
   (function(symbolName) {
      ...
      Symbol.bindElementAction(compId, symbolName, "${_hikist}", "click", function(sym, e) {
      ...
      Symbol.bindElementAction(compId, symbolName, "${_kakest}", "click", function(sym, e) {
         sym.getComposition().getStage().getSymbol("time").play();
         sym.setVariable("myVariableName", "variableValue");
          music.play();
         var button = new Howl({
      ...
      Symbol.bindElementAction(compId, symbolName, "${_tashist}", "click", function(sym, e) {
         sym.getComposition().getStage().getSymbol("time").play();
         sym.setVariable("myVariableName", "variableValue");
          music.play();
         var button = new Howl({
   ...
   (function(symbolName) {   
      ...
      Symbol.bindElementAction(compId, symbolName, "${_ura1}", "click", function(sym, e) {
         // マウスクリックのコードをここに挿入します
         // ユーザーがオブジェクトに触れたときに実行されるコードを挿入します（タッチデバイスの場合のみ）
...
sym.play("com");
      ...
      Symbol.bindElementAction(compId, symbolName, "${_ura2}", "click", function(sym, e) {
         // ユーザーがオブジェクトに触れたときに実行されるコードを挿入します（タッチデバイスの場合のみ）
...
sym.play("com");
      ...
      Symbol.bindElementAction(compId, symbolName, "${_ura3}", "click", function(sym, e) {
...
sym.play("com");
      ...
      Symbol.bindElementAction(compId, symbolName, "${_ura4}", "click", function(sym, e) {
...
sym.play("com");
      ...
      Symbol.bindElementAction(compId, symbolName, "${_ura5}", "click", function(sym, e) {
         // ユーザーがオブジェクトに触れたときに実行されるコードを挿入します（タッチデバイスの場合のみ）
...
sym.play("com");
      ...
      Symbol.bindElementAction(compId, symbolName, "${_ura6}", "click", function(sym, e) {
         // ユーザーがオブジェクトに触れたときに実行されるコードを挿入します（タッチデバイスの場合のみ）
...
sym.play("com");
      ...
      Symbol.bindElementAction(compId, symbolName, "${_ura7}", "click", function(sym, e) {
         // ユーザーがオブジェクトに触れたときに実行されるコードを挿入します（タッチデバイスの場合のみ）
...
sym.play("com");
      ...
      Symbol.bindElementAction(compId, symbolName, "${_ura8}", "click", function(sym, e) {
         // ユーザーがオブジェクトに触れたときに実行されるコードを挿入します（タッチデバイスの場合のみ）
...
sym.play("com");
      ...
      Symbol.bindElementAction(compId, symbolName, "${_ura9}", "click", function(sym, e) {
         // ユーザーがオブジェクトに触れたときに実行されるコードを挿入します（タッチデバイスの場合のみ）
...
sym.play("com");
      ...
      Symbol.bindElementAction(compId, symbolName, "${_ura10}", "click", function(sym, e) {
         // ユーザーがオブジェクトに触れたときに実行されるコードを挿入します（タッチデバイスの場合のみ）
...
sym.play("com");
      ...
      Symbol.bindElementAction(compId, symbolName, "${_ura11}", "click", function(sym, e) {
...
sym.play("com");
      ...
      Symbol.bindElementAction(compId, symbolName, "${_ura12}", "click", function(sym, e) {
         // ユーザーがオブジェクトに触れたときに実行されるコードを挿入します（タッチデバイスの場合のみ）
...
sym.play("com");
      ...
      Symbol.bindElementAction(compId, symbolName, "${_ura13}", "click", function(sym, e) {
         // ユーザーがオブジェクトに触れたときに実行されるコードを挿入します（タッチデバイスの場合のみ）
...
sym.play("com");
      ...
      Symbol.bindElementAction(compId, symbolName, "${_ura14}", "click", function(sym, e) {
         // ユーザーがオブジェクトに触れたときに実行されるコードを挿入します（タッチデバイスの場合のみ）
...
sym.play("com");
      ...
      Symbol.bindElementAction(compId, symbolName, "${_ura15}", "click", function(sym, e) {
         // マウスクリックのコードをここに挿入します
         // ユーザーがオブジェクトに触れたときに実行されるコードを挿入します（タッチデバイスの場合のみ）
...
sym.play("com");
      ...
      Symbol.bindElementAction(compId, symbolName, "${_ura16}", "click", function(sym, e) {
         // ユーザーがオブジェクトに触れたときに実行されるコードを挿入します（タッチデバイスの場合のみ）
...
sym.play("com");
      ...
      Symbol.bindElementAction(compId, symbolName, "${_ura17}", "click", function(sym, e) {
         // ユーザーがオブジェクトに触れたときに実行されるコードを挿入します（タッチデバイスの場合のみ）
...
sym.play("com");
      ...
      Symbol.bindElementAction(compId, symbolName, "${_ura18}", "click", function(sym, e) {
...
sym.play("com");
      ...
      Symbol.bindElementAction(compId, symbolName, "${_ura19}", "click", function(sym, e) {
         // ユーザーがオブジェクトに触れたときに実行されるコードを挿入します（タッチデバイスの場合のみ）
...
sym.play("com");
      ...
      Symbol.bindElementAction(compId, symbolName, "${_ura20}", "click", function(sym, e) {
         // ユーザーがオブジェクトに触れたときに実行されるコードを挿入します（タッチデバイスの場合のみ）
...
sym.play("com");
      ...
      Symbol.bindElementAction(compId, symbolName, "${_result}", "click", function(sym, e) {
         // ユーザーがオブジェクトに触れたときに実行されるコードを挿入します（タッチデバイスの場合のみ）
         var button = new Howl({
           urls: ['audio/button_kake.mp3'],
           autoplay: true,
      ...
      Symbol.bindElementAction(compId, symbolName, "${_gameselect}", "click", function(sym, e) {
