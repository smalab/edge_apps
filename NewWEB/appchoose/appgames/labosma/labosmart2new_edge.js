...
"Ice": {
   ...
   dom: [
   {
      ...
      },
      {
         ...
         text: '120円<br>',
         align: 'left',
         rect: ['0px','113px','75px','42px','auto','auto']
      }]
   }],
   symbolInstances: [
   ]
...
"Ice2": {
   ...
   dom: [
   {
      ...
      },
      {
         ...
         text: '115円<br>',
         align: 'left',
         rect: ['0px','118px','75px','42px','auto','auto']
      }]
   }],
   symbolInstances: [
   ]
...
"Title3": {
   ...
   },
   {
      ...
      {
         rect: ['155px','133px','135','80','auto','auto'],
         id: 'back',
         cursor: ['pointer'],
         type: 'group',
         c: [
   ...
   timelines: {
      "Default Timeline": {
         ...
         timeline: [
            { id: "eid351", tween: [ "style", "${_Title2}", "top", '0px', { fromValue: '0px'}], position: 0, duration: 0 },
            { id: "eid601", tween: [ "style", "${_koujityu}", "display", 'block', { fromValue: 'block'}], position: 0, duration: 0 },
            { id: "eid192", tween: [ "style", "${_Title2}", "display", 'block', { fromValue: 'block'}], position: 0, duration: 0 },
            { id: "eid193", tween: [ "style", "${_Title2}", "display", 'block', { fromValue: 'block'}], position: 28000, duration: 0 },
            { id: "eid350", tween: [ "style", "${_Title2}", "left", '0px', { fromValue: '0px'}], position: 0, duration: 0 }         ]
      }
