...
"stage": {
   ...
   content: {
         ...
         },
         {
            ...
            text:"このゲームはアナログどけいのじかんと　デジタルどけいのじかんを　合わせるゲームです。じかんが　ずれてしまったら そのぶんじかんを　もとにもどそう。",
            font:['\'ヒラギノ角ゴ Pro W3\', \'Hiragino Kaku Gothic Pro\', \'メイリオ\', Meiryo, \'ＭＳＰゴシック\', MS PGothic, sans-serif',24,"rgba(0,0,0,1)","normal","none",""]
         },
         {
            id:'Text3',
            type:'text',
            rect:['65px','753px','243px','78px','auto','auto'],
            text:"TIME SROT",
            align:"left",
            font:['\'ヒラギノ角ゴ Pro W3\', \'Hiragino Kaku Gothic Pro\', メイリオ, Meiryo, ＭＳＰゴシック, \'MS PGothic\', sans-serif',35,"rgba(0,39,255,1.00)","600","none","normal"]
         },
         {
            id:'Rectangle2',
            type:'rect',
         ...
         },
         {
            id:'monest4',
            type:'image',
            rect:['30px','1083px','700px','220px','auto','auto'],
            fill:["rgba(0,0,0,0)",im+"monest4.png",'0px','0px']
         },
         {
            id:'TIME_SLOT_22',
            type:'image',
            rect:['300px','803px','200px','200px','auto','auto'],
            fill:["rgba(0,0,0,0)",im+"TIME_SLOT_22.png",'0px','0px']
         },
         {
            id:'cover',
            display:'none',
         ...
         },
         {
            id:'smako_2',
            type:'image',
            rect:['450px','769px','215px','216px','auto','auto'],
            fill:["rgba(0,0,0,0)",im+"smako%202.png",'0px','0px']
         },
         {
            id:'smao',
            type:'image',
            rect:['47px','782px','234px','242px','auto','auto'],
